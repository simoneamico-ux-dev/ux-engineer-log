...
<p className="article-meta"><time dateTime="2026-03-11">Scritto l'11 marzo del 2026</time></p>
...
<div style={{ 
  ...
  <p className="hero-subtitle">Componenti copiabili,<br />zero dipendenze</p>
</div>
