...
<p className="article-meta"><time dateTime="2025-12-22">Scritto il 22 dicembre del 2025</time></p>
...
<div style={{
  ...
  <figure className="image-caption-figure" style={{ flex: '0.647 1 0px', minWidth: '200px' }}>
    <img 
    ...
    />
    <figcaption className="image-caption image-caption--media">Prototipo Figma</figcaption>
  </figure>

  <figure className="image-caption-figure" style={{ flex: '1.593 1 0px', minWidth: '280px' }}>
    <video 
    ...
    />
    <figcaption className="image-caption image-caption--media">Implementazione Reale (Codice) • Velocità 0.5x</figcaption>
  </figure>
