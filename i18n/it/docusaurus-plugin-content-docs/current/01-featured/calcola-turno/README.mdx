...
<p className="article-meta"><time dateTime="2026-01-14">Scritto il 14 gennaio del 2026</time></p>
...
<div style={{ display: 'flex', justifyContent: 'center', margin: '20px 0' }}>
  <figure className="image-caption-figure" style={{ maxWidth: '320px' }}>
    <img 
    ...
    />
    <figcaption className="image-caption image-caption--version">La versione 1.0 (2024)</figcaption>
  </figure>
</div>
...
Mi premeva l'impatto sulla batteria, che ho scoperto essere **bassissimo**. Questo perché la CPU si sveglia per un micro-istante, controlla un numero, vede che non è cambiato nulla e torna "a dormire". È molto più costoso per la batteria gestire il rendering grafico o la connessione alla rete. <br />
...
Credo sia il medesimo tema del public speaking. Carlo Loiudice diceva (non ricordo se in uno dei suoi corsi oppure nei suoi podcast) che il pubblico è egoista: non gli interessa chi sei, cosa hai fatto e perché sei lì a parlare, bensì **cosa si porta a casa** di quello che dici. <br />
