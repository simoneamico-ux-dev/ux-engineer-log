...
```html
<!DOCTYPE html>
<!-- 🎮 DICHIARAZIONE HTML5: "Benvenuti nel nostro Gioco Platformer 2D!" -->
<!-- È come porre le fondamenta per il nostro parco giochi digitale! 🏗️ -->

<html lang="en">
<!-- 🌍 CONTENITORE PRINCIPALE: L'intero universo di gioco -->
<!-- lang="en" = Lingua inglese, universale per le esperienze di codifica -->

  <head>
    <!-- 🧠 CENTRO DI COMANDO: Dove impostiamo l'ambiente di gioco -->
    <!-- Come la sala di controllo di un cabinato arcade! 🕹️ -->
    
    <meta charset="UTF-8" />
    <!-- 📝 CODIFICA CARATTERI: Supporta tutti i simboli di testo necessari per il nostro gioco -->
    <!-- UTF-8 assicura che tutto, dal testo del gioco ai commenti di codice, venga visualizzato correttamente -->
    
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <!-- 🔄 COMPATIBILITÀ BROWSER: Garantisce il rendering moderno di IE -->
    <!-- Dice a Internet Explorer di utilizzare il suo motore di rendering più moderno -->
    
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <!-- 📱 CONFIGURAZIONE RESPONSIVE: "Questo gioco si adatta a qualsiasi schermo!" -->
    <!-- Rende il nostro gioco correttamente dimensionato su tutti i dispositivi, dai telefoni ai desktop -->
    
    <title>Learn Intermediate OOP by Building a Platformer Game</title>
    <!-- 📑 TITOLO SCHEDA: Scopo educativo chiaramente definito -->
    <!-- OOP = Programmazione Orientata agli Oggetti, la base dello sviluppo di giochi moderni -->
    
    <style>
      /* 🎨 ===== STILI CSS: Il Mondo Visivo del Gioco ===== */
      
      * {
        margin: 0;
        padding: 0;
        box-sizing: border-box;
        /* 🧹 PULIZIA TOTALE: Resetta tutti gli spazi predefiniti del browser */
        /* Assicura che il nostro gioco abbia un aspetto coerente su tutti i browser */
        /* È come livellare il terreno prima di costruire il nostro mondo di gioco */
      }
      ...
      :root {
        ...
        --section-bg-color: #ffffff;
        --golden-yellow: #feac32;
        /* 🎨 VARIABILI COLORE: Definizione centrale della palette */
        /* L'uso di variabili CSS rende i cambiamenti di tema facili e coerenti */
        /* È come definire i colori principali per il nostro mondo di gioco */
      }
      
      body {
        background-color: var(--main-bg-color);
        /* 🌌 SFONDO BLU SCURO: Crea un'atmosfera immersiva */
      ...
      .start-screen {
        ...
        margin-right: -50%;
        transform: translate(-50%, -50%);
        /* ⚖️ CENTRATURA PERFETTA: Il trucco transform centra l'elemento con precisione */
        /* Centrato orizzontalmente E verticalmente indipendentemente dalla dimensione del contenuto */
        
        border-radius: 30px;
        /* 🔄 ANGOLI ARROTONDATI: Ammorbidiscono l'aspetto visivo */
        /* Crea un'interfaccia utente più moderna e amichevole per i giocatori */
        
        padding: 20px;
        padding-bottom: 5px;
        /* 📏 SPAZIATURA INTERNA: Spazio di respiro per il contenuto */
        /* Un padding diverso sopra/sotto crea equilibrio visivo */
      }
      
      .main-title {
        text-align: center;
        /* ⚖️ TITOLO CENTRATO: Punto focale della schermata iniziale */
      ...
      .instructions {
        ...
        margin: 15px;
        line-height: 2rem;
        /* 📝 ISTRUZIONI CHIARE: Testo ottimizzato per la leggibilità */
        /* font-size: 1.2rem = 20% più grande del testo predefinito */
        /* line-height: 2rem = interlinea doppia per una lettura più facile */
        /* Assicura che i giocatori comprendano come giocare prima di iniziare */
      }
      
      .btn {
        cursor: pointer;
        /* 👆 CURSORE A MANO: Indicazione visiva che l'elemento è cliccabile */
        
        width: 100px;
        margin: 10px;
        /* 📏 DIMENSIONI PULSANTE: Dimensione confortevole per l'area di click */
        /* 100px di larghezza con 10px di margine crea una buona spaziatura */
        
        color: #0a0a23;
        font-size: 18px;
        /* 🔤 STILE TESTO: Testo scuro su pulsante chiaro per leggibilità */
        /* 18px di dimensione assicura che il testo sia facilmente leggibile su tutti i dispositivi */
        
        background-color: var(--golden-yellow);
        background-image: linear-gradient(#fecc4c, #ffac33);
        /* 🌅 SFONDO GRADIENTE: Crea effetto pulsante 3D */
        /* Parte superiore più chiara, inferiore più scura crea l'illusione di luce dall'alto */
        
        border-color: var(--golden-yellow);
        border-width: 3px;
        /* 🔲 STILE BORDO: Bordo spesso che si abbina allo sfondo */
        /* 3px di larghezza rende il bordo chiaramente visibile */
      }
      
      .btn:hover {
        background-image: linear-gradient(#ffcc4c, #f89808);
        /* ✨ EFFETTO HOVER: Il pulsante si illumina quando il mouse ci passa sopra */
      ...
      .btn-container {
        ...
        align-items: center;
        justify-content: center;
        /* 📦 CENTRATURA FLEXBOX: Allineamento orizzontale perfetto */
      ...
      .checkpoint-screen {
        ...
        margin-left: auto;
        margin-right: auto;
        /* ⚖️ CENTRATURA ORIZZONTALE: Tecnica tradizionale */
        ...
        border-radius: 20px;
        padding: 10px;
        /* 📋 STILE POPUP: Notifica pulita e leggibile */
        /* Sfondo bianco con angoli arrotondati per un look moderno */
        
        display: none;
        /* 🙈 INIZIALMENTE NASCOSTO: Appare solo ai checkpoint */
        /* JavaScript cambierà questo in "block" quando necessario */
      }
      
      #canvas {
        display: none;
        /* 🙈 CANVAS NASCOSTO: Rivelato quando il gioco inizia */
        /* Inizialmente nascosto per mostrare invece la schermata iniziale */
      }
      
      @media (min-width: 768px) {
        /* 📱 BREAKPOINT RESPONSIVE: Tablet e schermi più grandi */
        /* 768px è la larghezza standard di un tablet in portrait */
        
        .start-screen {
          width: 60%;
          max-width: 700px;
          /* 📏 DIMENSIONAMENTO DESKTOP: Pannello più stretto e centrato */
        ...
        .checkpoint-screen {
          max-width: 300px;
          /* 📏 DIMENSIONAMENTO NOTIFICHE: Compatto su schermi più grandi */
          /* 300px è abbastanza largo per il contenuto ma non invadente */
        }
      }
    </style>
  </head>
  <body>
    <!-- 🎮 ===== INTERFACCIA DEL GIOCO: La Finestra del Giocatore sul Mondo ===== -->
    
    <div class="start-screen">
      <!-- 🎬 SCHERMATA INIZIALE: Il menu iniziale del gioco -->
      <!-- Come la schermata del titolo dei giochi arcade classici! -->
      
      <h1 class="main-title">freeCodeCamp Code Warrior</h1>
      <!-- 📑 TITOLO DEL GIOCO: Stabilisce il tema e il brand -->
      <!-- "Code Warrior" suggerisce un'avventura a tema coding -->
      
      <p class="instructions">
        Help the main player navigate to the yellow checkpoints.
      </p>
      <!-- 📝 OBIETTIVO DEL GIOCO: Descrizione chiara degli obiettivi -->
      <!-- Dice esattamente al giocatore cosa deve fare -->
      
      <p class="instructions">
        Use the keyboard arrows to move the player around.
      </p>
      <!-- 🎮 SCHEMA DI CONTROLLO 1: Spiegazione dei controlli di movimento -->
      <!-- I tasti freccia sono intuitivi per il movimento 2D -->
      
      <p class="instructions">You can also use the spacebar to jump.</p>
      <!-- 🎮 SCHEMA DI CONTROLLO 2: Meccanica di salto spiegata -->
      <!-- La barra spaziatrice è il pulsante di salto standard nella maggior parte dei platformer -->

      <div class="btn-container">
        <!-- 📦 WRAPPER PULSANTE: Centra il pulsante di avvio -->
        
        <button class="btn" id="start-btn">Start Game</button>
        <!-- 🎯 PULSANTE AVVIO: Inizia il gioco -->
        <!-- Elemento interattivo cruciale con ID unico per JavaScript -->
      </div>
    </div>

    <div class="checkpoint-screen">
      <!-- 🏆 NOTIFICA CHECKPOINT: Appare quando si raggiungono gli obiettivi -->
      <!-- Fornisce feedback positivo per i traguardi del giocatore -->
      
      <h2>Congrats!</h2>
      <!-- 🎉 INTESTAZIONE CELEBRATIVA: Rinforzo positivo -->
      <!-- Un messaggio di congratulazioni crea soddisfazione -->
      
      <p>You reached the last checkpoint.</p>
      <!-- 📝 MESSAGGIO DI TRAGUARDO: Chiarisce cosa è successo -->
      <!-- Sarà aggiornato via JavaScript per i diversi checkpoint -->
    </div>

    <canvas id="canvas"></canvas>
    <!-- 🖼️ ELEMENTO CANVAS: La superficie di rendering effettiva del gioco -->
    <!-- Il Canvas HTML5 è come una tavola da disegno vuota per il nostro JavaScript -->
    <!-- Tutte le visuali del gioco saranno disegnate qui programmaticamente -->

    <script>
      /* 🎮 ===== JAVASCRIPT: Il Motore del Gioco! ===== */
      
      /* 🔍 ===== SELEZIONE ELEMENTI DOM: Collegamento di JS a HTML ===== */
      
      const startBtn = document.getElementById("start-btn");
      /* 🔘 RIFERIMENTO PULSANTE AVVIO: Accesso diretto tramite ID */
      /* getElementById è il metodo di selezione più veloce - perfetto per elementi critici */
      /* Come afferrare l'interruttore di accensione per il motore del nostro gioco */
      
      const canvas = document.getElementById("canvas");
      /* 🖼️ RIFERIMENTO CANVAS: La nostra superficie di disegno */
      /* Questo elemento diventerà il nostro intero mondo di gioco */
      /* Come ottenere una tela vuota prima di dipingere un capolavoro */
      
      const startScreen = document.querySelector(".start-screen");
      /* 🎬 RIFERIMENTO SCHERMATA INIZIALE: Uso del selettore di classe */
      /* querySelector trova il primo elemento corrispondente con questa classe */
      /* Lo nasconderemo quando il gioco inizia */
      
      const checkpointScreen = document.querySelector(".checkpoint-screen");
      /* 🏆 RIFERIMENTO SCHERMATA CHECKPOINT: Per i messaggi di vittoria */
      /* Questo popup apparirà quando i giocatori raggiungono i checkpoint */
      
      const checkpointMessage = document.querySelector(".checkpoint-screen > p");
      /* 📝 RIFERIMENTO MESSAGGIO: Selettore figlio diretto */
      ...
      /* 🎨 ===== CONFIGURAZIONE CANVAS: Preparazione della Superficie di Disegno ===== */
      
      const ctx = canvas.getContext("2d");
      /* 🖌️ CONTESTO DI DISEGNO: L'API di disegno effettiva */
      /* getContext("2d") ci dà accesso agli strumenti di disegno Canvas */
      /* Come ottenere un pennello da usare sulla nostra tela */
      /* È ciò che useremo per disegnare forme, colori e il mondo di gioco */
      
      canvas.width = innerWidth;
      canvas.height = innerHeight;
      /* 📏 DIMENSIONI CANVAS: Dimensione a schermo intero */
      ...
      /* 🌍 ===== COSTANTI DELLA FISICA DI GIOCO: Le Regole del Nostro Mondo ===== */
      
      const gravity = 0.5;
      /* ⬇️ COSTANTE DI GRAVITÀ: Forza che tira il giocatore verso il basso */
      /* Questa non è la gravità realistica della Terra (9,8 m/s²) ma un valore che "si sente bene" */
      /* Ogni frame aggiunge 0,5 alla velocità verticale → caduta accelerata */
      /* Valori più alti = caduta più rapida, valori più bassi = salti più fluttuanti */
      
      let isCheckpointCollisionDetectionActive = true;
      /* 🚦 FLAG DI COLLISIONE: Controlla il rilevamento dei checkpoint */
      /* Questo booleano funziona come un interruttore on/off per le interazioni con i checkpoint */
      /* Quando è false, impedisce che lo stesso checkpoint attivi più volte */
      /* Fondamentale per evitare che il checkpoint si attivi 60 volte al secondo! */
      
      /* 📏 ===== FUNZIONE DI SCALATURA: Elementi di Gioco Responsive ===== */
      
      const proportionalSize = (size) => {
        return innerHeight < 500 ? Math.ceil((size / 500) * innerHeight) : size;
        /* 📱 SCALATURA ADATTIVA: Gli elementi si ridimensionano per schermi piccoli */
        /* Se l'altezza dello schermo < 500px: scala tutto proporzionalmente */
        /* Formula: (dimensione ÷ altezza di riferimento) × altezza effettiva */
        /* Math.ceil() arrotonda per eccesso per evitare elementi di dimensione zero */
        /* Su schermi più alti: usa i valori di dimensione originali */
        /* Come avere un progetto responsive per il nostro mondo di gioco */
      }
      
      /* 🧍 ===== CLASSE PLAYER: Il Personaggio Principale ===== */
      
      class Player {
        /* 📘 DEFINIZIONE CLASSE: Blueprint per creare i giocatori */
        /* Le classi sono modelli che definiscono proprietà e comportamenti */
        /* Come definire cosa fa un "giocatore" nel nostro universo di gioco */
        
        constructor() {
          /* 🏗️ METODO COSTRUTTORE: Eseguito quando si crea un nuovo Player */
          /* Questo metodo inizializza tutte le proprietà del giocatore */
          ...
          /* 📍 POSIZIONE INIZIALE: Dove inizia il giocatore */
          ...
          this.velocity = {
            x: 0, /* Velocità orizzontale (pixel per frame) */
            y: 0, /* Velocità verticale (pixel per frame) */
          };
          /* 🏎️ VETTORE VELOCITÀ: Velocità e direzione */
          /* Componenti x/y separate consentono movimento orizzontale/verticale indipendente */
          /* 0 significa fermo in ogni direzione */
          
          this.width = proportionalSize(40);
          this.height = proportionalSize(40);
          /* 📏 DIMENSIONI GIOCATORE: Dimensione del personaggio */
        ...
        draw() {
          /* 🎨 METODO DI DISEGNO: Renderizza il giocatore sullo schermo */
          /* Chiamato ogni frame per mostrare il giocatore */
          
          ctx.fillStyle = "#99c9ff";
          /* 🎨 COLORE GIOCATORE: Azzurro chiaro */
          /* Imposta il "colore della pittura" prima di disegnare */
          
          ctx.fillRect(this.position.x, this.position.y, this.width, this.height);
          /* 📦 DISEGNA RETTANGOLO: Crea la forma del giocatore */
        ...
        update() {
          /* 🔄 METODO DI AGGIORNAMENTO: Fisica e logica di gioco */
          /* Chiamato ogni frame (60 volte al secondo) */
          /* Il cuore del comportamento del giocatore nel gioco */
          
          this.draw();
          /* 🎨 RENDERIZZA PRIMA: Assicura che il giocatore sia visibile */
          /* Disegna sempre prima di muoversi per prevenire glitch visivi */
          
          this.position.x += this.velocity.x;
          this.position.y += this.velocity.y;
          /* 🚶 FISICA DEL MOVIMENTO: La posizione cambia in base alla velocità */
          /* Questa è l'equazione fondamentale del movimento: posizione += velocità */
          /* La direzione e la velocità del movimento dipendono dai valori di velocità */
          
          if (this.position.y + this.height + this.velocity.y <= canvas.height) {
            /* 🌡️ CONTROLLO GRAVITÀ: Il giocatore è ancora in aria? */
            ...
            if (this.position.y < 0) {
              /* 🛑 CONTROLLO LIMITE SUPERIORE: Il giocatore sta cercando di uscire dallo schermo? */
              /* y < 0 significa che il giocatore sta cercando di saltare sopra il canvas */
              
              this.position.y = 0;
              this.velocity.y = gravity;
              /* 🔄 COLLISIONE CON SOFFITTO: Rimbalza il giocatore verso il basso */
              /* Impedisce di andare sopra lo schermo e inizia a cadere */
            }
            
            this.velocity.y += gravity;
            /* ⬇️ APPLICA GRAVITÀ: Aumenta la velocità di caduta */
            /* Questo crea accelerazione - la caduta diventa più veloce nel tempo */
            /* La base della fisica di salto realistica! */
          } else {
            /* 🛑 COLLISIONE COL PAVIMENTO: Il giocatore ha raggiunto il fondo */
            
            this.velocity.y = 0;
            /* 🛑 FERMA LA CADUTA: Imposta la velocità verticale a zero */
            /* Impedisce al giocatore di cadere attraverso il pavimento */
          }
      
          if (this.position.x < this.width) {
            /* 🛑 CONTROLLO LIMITE SINISTRO: Impedisce di uscire dallo schermo a sinistra */
            
            this.position.x = this.width;
            /* 🔙 RESPINGE: Imposta la posizione al bordo dello schermo */
            /* Crea un muro invisibile al bordo sinistro dello schermo */
          }
      
          if (this.position.x >= canvas.width - this.width * 2) {
            /* 🛑 CONTROLLO LIMITE DESTRO: Impedisce di uscire dallo schermo a destra */
      ...
      /* 🧱 ===== CLASSE PLATFORM: Il Terreno Solido ===== */
      
      class Platform {
        /* 📘 DEFINIZIONE CLASSE: Blueprint per le piattaforme */
        /* Ogni piattaforma è una superficie su cui il giocatore può stare */
        
        constructor(x, y) {
          /* 🏗️ COSTRUTTORE CON PARAMETRI: Piattaforme personalizzabili */
          ...
          /* 📍 POSIZIONE PIATTAFORMA: Posizionamento personalizzato */
          /* JS moderno permette l'abbreviazione quando nome proprietà = nome variabile */
          /* Questo crea la piattaforma alle coordinate esatte specificate */
          
          this.width = 200;
          this.height = proportionalSize(40);
          /* 📏 DIMENSIONE PIATTAFORMA: Larghezza e altezza */
          /* 200px di larghezza crea piattaforme su cui il giocatore può correre */
          /* L'altezza si adatta alla dimensione dello schermo per coerenza */
        }
        
        draw() {
          /* 🎨 METODO DI DISEGNO: Renderizza la piattaforma sullo schermo */
          
          ctx.fillStyle = "#acd157";
          /* 🎨 COLORE PIATTAFORMA: Verde chiaro */
          /* Un colore simile all'erba distingue le piattaforme dal giocatore */
          
          ctx.fillRect(this.position.x, this.position.y, this.width, this.height);
          /* 📦 DISEGNA RETTANGOLO: Crea la forma della piattaforma */
          /* Un semplice rettangolo rappresenta ogni piattaforma */
        }
      }
      
      /* 🚩 ===== CLASSE CHECKPOINT: I Marcatori degli Obiettivi ===== */
      
      class CheckPoint {
        /* 📘 DEFINIZIONE CLASSE: Blueprint per i marcatori degli obiettivi */
        /* Questi sono gli obiettivi che il giocatore deve raggiungere */
        
        constructor(x, y, z) {
          /* 🏗️ COSTRUTTORE CON PARAMETRI: Checkpoint personalizzabili */
          ...
          /* 📍 POSIZIONE CHECKPOINT: Posizionamento personalizzato */
          /* Usa la stessa sintassi abbreviata di Platform */
          
          this.width = proportionalSize(40);
          this.height = proportionalSize(70);
          /* 📏 DIMENSIONE CHECKPOINT: Alto e stretto */
          /* Più alto del giocatore per essere facilmente visibile */
          
          this.claimed = false;
          /* 🚩 FLAG CLAIMED: Tiene traccia dello stato del checkpoint */
          /* false = non ancora raggiunto, true = già raccolto */
          /* Come una bandierina virtuale "Sono stato qui" che il giocatore pianta */
        };
      
        draw() {
          /* 🎨 METODO DI DISEGNO: Renderizza il checkpoint sullo schermo */
          
          ctx.fillStyle = "#f1be32";
          /* 🎨 COLORE CHECKPOINT: Giallo dorato */
          /* Il colore brillante fa risaltare i checkpoint come obiettivi */
          
          ctx.fillRect(this.position.x, this.position.y, this.width, this.height);
          /* 📦 DISEGNA RETTANGOLO: Crea la forma del checkpoint */
          /* Il rettangolo verticale assomiglia a una bandiera del traguardo */
        }
        
        claim() {
          /* 🏁 METODO CLAIM: "Raccoglie" il checkpoint */
          /* Chiamato quando il giocatore raggiunge questo checkpoint */
          
          this.width = 0;
          this.height = 0;
          /* 🙈 RENDI INVISIBILE: Dimensioni zero lo nascondono */
          /* Piuttosto che rimuoverlo dall'array, lo rendiamo invisibile */
          
          this.position.y = Infinity;
          /* 🌠 MANDA VIA: Sposta fuori dallo schermo */
          /* Infinity garantisce che non possa mai più essere colpito */
          /* Questo è più sicuro che modificare l'array durante l'iterazione */
          
          this.claimed = true;
          /* 🚩 SEGNA COME CLAIMED: Aggiorna il flag di stato */
      ...
      /* 🏭 ===== CREAZIONE OGGETTI DI GIOCO: Costruzione del Mondo ===== */
      
      const player = new Player();
      /* 🧍 CREA GIOCATORE: Istanza della classe Player */
      ...
      const platformPositions = [
        ...
        { x: 900, y: proportionalSize(350) },
        { x: 1050, y: proportionalSize(150) },
        { x: 2500, y: proportionalSize(450) },  /* Gap grande → sfida! */
        { x: 2900, y: proportionalSize(400) },
        { x: 3150, y: proportionalSize(350) },
      ...
      /* 🗺️ DESIGN DEL LIVELLO: Array delle coordinate delle piattaforme */
      /* Ogni oggetto contiene la posizione x,y per una piattaforma */
      /* Questo è il nostro "progetto del livello" - separa i dati dalla logica */
      /* I commenti indicano dove si verificano gap impegnativi nel livello */
      
      const platforms = platformPositions.map(
        (platform) => new Platform(platform.x, platform.y)
      );
      /* 🏭 CREAZIONE PIATTAFORME: Trasforma i dati in oggetti */
      /* map() converte ogni posizione in una Platform funzionante */
      /* È come una catena di montaggio: dati in ingresso → oggetti in uscita */
      ...
      /* 🚩 POSIZIONI CHECKPOINT: Coordinate degli obiettivi */
      ...
      /* 🏭 CREAZIONE CHECKPOINT: Trasforma i dati in oggetti */
      /* Stesso schema di mapping delle piattaforme, crea oggetti CheckPoint */
      
      /* 🔄 ===== GAME LOOP: Il Motore di Animazione ===== */
      
      const animate = () => {
        /* 🎬 GAME LOOP PRINCIPALE: Funzione eseguita ogni frame */
        /* Questo è il battito cardiaco del nostro gioco - tutto accade qui */
        
        requestAnimationFrame(animate);
        /* 🔄 CREAZIONE LOOP: API di animazione del browser */
        ...
        ctx.clearRect(0, 0, canvas.width, canvas.height);
        /* 🧹 PULISCI CANVAS: Cancella il frame precedente */
        ...
        /* 🎨 DISEGNA PIATTAFORME: Renderizza tutte le piattaforme */
        ...
        /* 🎨 DISEGNA CHECKPOINT: Renderizza tutti i checkpoint */
        /* Stesso schema delle piattaforme - disegna ogni checkpoint */
      
        player.update();
        /* 🔄 AGGIORNA GIOCATORE: Fisica e rendering */
        /* Questo chiama il metodo update del giocatore che:
           1. Disegna il giocatore
           2. Aggiorna la posizione in base alla velocità
           3. Applica gravità e controlli dei limiti */
      
        /* 📷 ===== MOVIMENTO DELLA CAMERA: Scorrimento del Mondo ===== */
        
        if (keys.rightKey.pressed && player.position.x < proportionalSize(400)) {
          /* 🏃‍♂️ MOVIMENTO GIOCATORE DESTRA: Sposta il giocatore quando è lontano dal centro */
          /* Quando il tasto destro è premuto E il giocatore è a sinistra del punto centrale */
          
          player.velocity.x = 5;
          /* ➡️ IMPOSTA VELOCITÀ: Muove il giocatore a destra */
          /* 5 pixel per frame creano un movimento fluido */
        } else if (keys.leftKey.pressed && player.position.x > proportionalSize(100)) {
          /* 🏃‍♂️ MOVIMENTO GIOCATORE SINISTRA: Sposta il giocatore quando è lontano dal bordo sinistro */
          /* Quando il tasto sinistro è premuto E il giocatore è a destra del limite sinistro */
          
          player.velocity.x = -5;
          /* ⬅️ IMPOSTA VELOCITÀ: Muove il giocatore a sinistra */
          /* Velocità negativa significa movimento verso sinistra */
        } else {
          /* 🛑 POSIZIONE CENTRALE: Giocatore vicino al centro o ai bordi */
          
          player.velocity.x = 0;
          /* 🛑 FERMA MOVIMENTO ORIZZONTALE: Giocatore fermo */
          /* Reimposta la velocità a zero - il giocatore smette di muoversi orizzontalmente */
      
          /* 🌎 SCORRIMENTO MONDO: Sposta l'ambiente invece del giocatore */
          /* Questo crea l'illusione di una camera che segue il giocatore */
          
          if (keys.rightKey.pressed && isCheckpointCollisionDetectionActive) {
            /* ➡️ SCORRI DESTRA: Sposta il mondo quando il giocatore è centrato */
            /* Attivo solo quando la rilevazione delle collisioni con checkpoint è abilitata */
            
            platforms.forEach((platform) => {
              platform.position.x -= 5;
              /* ⬅️ SPOSTA PIATTAFORME A SINISTRA: Il mondo scorre in direzione opposta al giocatore */
              /* Crea l'illusione che il giocatore si muova verso destra */
            });
      
            checkpoints.forEach((checkpoint) => {
              checkpoint.position.x -= 5;
              /* ⬅️ SPOSTA CHECKPOINT A SINISTRA: Mantiene sincronizzati con le piattaforme */
              /* Tutto nel mondo si muove insieme per uno scorrimento coerente */
            });
          
          } else if (keys.leftKey.pressed && isCheckpointCollisionDetectionActive) {
            /* ⬅️ SCORRI SINISTRA: Sposta il mondo quando il giocatore è centrato */
            
            platforms.forEach((platform) => {
              platform.position.x += 5;
              /* ➡️ SPOSTA PIATTAFORME A DESTRA: Il mondo scorre in direzione opposta al giocatore */
              /* Crea l'illusione che il giocatore si muova verso sinistra */
            });
      
            checkpoints.forEach((checkpoint) => {
              checkpoint.position.x += 5;
              /* ➡️ SPOSTA CHECKPOINT A DESTRA: Mantiene sincronizzati con le piattaforme */
            });
          }
        }
      
        /* 💥 ===== RILEVAMENTO COLLISIONI CON PIATTAFORME ===== */
        
        platforms.forEach((platform) => {
          /* 🔍 CONTROLLA OGNI PIATTAFORMA: Itera attraverso tutte le piattaforme */
          
          const collisionDetectionRules = [
            player.position.y + player.height <= platform.position.y,
            /* ⬇️ REGOLA 1: Fondo del giocatore sopra la parte superiore della piattaforma */
            /* Assicura che il giocatore stia scendendo sulla piattaforma dall'alto */
            
            player.position.y + player.height + player.velocity.y >= platform.position.y,
            /* ⬇️ REGOLA 2: La prossima posizione del giocatore intersecherà la piattaforma */
            /* Prevede la collisione basata sulla velocità attuale */
            
            player.position.x >= platform.position.x - player.width / 2,
            /* ⬅️ REGOLA 3: Giocatore non troppo a sinistra della piattaforma */
            /* Controllo posizione orizzontale - bordo sinistro */
            
            player.position.x <=
              platform.position.x + platform.width - player.width / 3,
            /* ➡️ REGOLA 4: Giocatore non troppo a destra della piattaforma */
            /* Controllo posizione orizzontale - bordo destro */
          ];
      
          if (collisionDetectionRules.every((rule) => rule)) {
            /* ✅ TUTTE LE REGOLE VERE: In piedi sulla piattaforma */
            /* every() verifica se TUTTE le condizioni restituiscono true */
            /* Questo è come un AND logico tra tutte le condizioni */
            
            player.velocity.y = 0;
            /* 🛑 FERMA CADUTA: Atterra sulla piattaforma */
            /* Velocità verticale zero impedisce di cadere attraverso la piattaforma */
            
            return;
            /* 🚪 ESCI DAL LOOP: Salta le piattaforme rimanenti */
            /* Una volta trovata una collisione, non c'è bisogno di controllare le altre */
          }
      
          /* 💥 COLLISIONE DAL BASSO: Colpisce la piattaforma da sotto */
          
          const platformDetectionRules = [
            player.position.x >= platform.position.x - player.width / 2,
            /* ⬅️ REGOLA 1: Controllo sovrapposizione orizzontale (sinistra) */
            
            player.position.x <=
              platform.position.x + platform.width - player.width / 3,
            /* ➡️ REGOLA 2: Controllo sovrapposizione orizzontale (destra) */
            
            player.position.y + player.height >= platform.position.y,
            /* ⬆️ REGOLA 3: Fondo del giocatore sotto la parte superiore della piattaforma */
            
            player.position.y <= platform.position.y + platform.height,
            /* ⬇️ REGOLA 4: Parte superiore del giocatore sopra la parte inferiore della piattaforma */
          ];
      
          if (platformDetectionRules.every(rule => rule)) {
            /* ✅ TUTTE LE REGOLE VERE: Colpisce la piattaforma dal basso */
            
            player.position.y = platform.position.y + player.height;
            /* ⬇️ SPINGE GIÙ: Sposta il giocatore sotto la piattaforma */
            /* Impedisce di rimanere bloccati all'interno della piattaforma */
            
            player.velocity.y = gravity;
            /* ⬇️ INIZIA A CADERE: Applica la gravità */
            /* Rimbalza il giocatore verso il basso dopo aver colpito con la testa */
          };
        });
      
        /* 🚩 ===== RILEVAMENTO COLLISIONI CON CHECKPOINT ===== */
        
        checkpoints.forEach((checkpoint, index, checkpoints) => {
          /* 🔍 CONTROLLA OGNI CHECKPOINT: Itera attraverso tutti i checkpoint */
          /* index = posizione nell'array, checkpoints = l'array completo */
          
          const checkpointDetectionRules = [
            player.position.x >= checkpoint.position.x,
            /* ➡️ REGOLA 1: Bordo destro del giocatore oltre il bordo sinistro del checkpoint */
            
            player.position.y >= checkpoint.position.y,
            /* ⬇️ REGOLA 2: Giocatore sotto la parte superiore del checkpoint */
            
            player.position.y + player.height <=
              checkpoint.position.y + checkpoint.height,
            /* ⬆️ REGOLA 3: Giocatore entro i limiti verticali del checkpoint */
            
            isCheckpointCollisionDetectionActive,
            /* 🚦 REGOLA 4: Il sistema di rilevamento collisioni è attivo */
            /* Impedisce attivazioni multiple quando l'interruttore globale è spento */
            
            player.position.x - player.width <=
              checkpoint.position.x - checkpoint.width + player.width * 0.9,
            /* ⬅️ REGOLA 5: Controllo di allineamento orizzontale complesso */
            /* Assicura che il giocatore sia posizionato correttamente rispetto al checkpoint */
            
            index === 0 || checkpoints[index - 1].claimed === true,
            /* 🔢 REGOLA 6: Controllo ordine checkpoint */
            /* O questo è il primo checkpoint O quello precedente è stato reclamato */
            /* Forza la raccolta sequenziale dei checkpoint */
          ];
      
          if (checkpointDetectionRules.every((rule) => rule)) {
            /* ✅ TUTTE LE REGOLE VERE: Checkpoint raggiunto */
            
            checkpoint.claim();
            /* 🏁 RECLAMA CHECKPOINT: Segna come raggiunto */
            /* Questo nasconde il checkpoint e lo marca come claimed */
      
            if (index === checkpoints.length - 1) {
              /* 🏆 CHECKPOINT FINALE: Ultimo nell'array */
              /* Lunghezza - 1 è l'indice dell'ultimo elemento */
              
              isCheckpointCollisionDetectionActive = false;
              /* 🚫 DISABILITA COLLISIONI: Il gioco effettivamente finisce */
              /* Impedisce ulteriori attivazioni di checkpoint */
              
              showCheckpointScreen("You reached the final checkpoint!");
              /* 🎉 MESSAGGIO DI VITTORIA: Traguardo finale */
              /* Mostra un messaggio di congratulazioni con testo personalizzato */
              
              movePlayer("ArrowRight", 0, false);
              /* 🛑 FERMA GIOCATORE: Previene il movimento dopo la vittoria */
              /* Reimposta lo stato del movimento per far fermare il giocatore */
            } else if (player.position.x >= checkpoint.position.x && player.position.x <= checkpoint.position.x + 40) {
              /* ✅ CHECKPOINT REGOLARE: Non l'ultimo */
              /* Controllo posizione aggiuntivo assicura il corretto timing di attivazione */
              
              showCheckpointScreen("You reached a checkpoint!");
              /* 🎉 MESSAGGIO DI PROGRESSO: Traguardo intermedio */
            }
          };
        });
      }
      
      /* 🎮 ===== TRACCIAMENTO STATO TASTIERA ===== */
      ...
      /* 🎮 OGGETTO STATO TASTIERA: Tiene traccia dei tasti premuti */
      /* Oggetti nidificati: keys → rightKey → pressed */
      ...
      const movePlayer = (key, xVelocity, isPressed) => {
        /* 🏃‍♂️ FUNZIONE MOVIMENTO GIOCATORE: Elabora le azioni dei tasti */
        /* key = quale tasto è stato premuto */
        /* xVelocity = quanto velocemente muoversi */
        /* isPressed = tasto premuto o rilasciato? */
        
        if (!isCheckpointCollisionDetectionActive) {
          /* 🚫 CONTROLLO FINE GIOCO: Blocca il movimento se il gioco è finito */
          
          player.velocity.x = 0;
          player.velocity.y = 0;
          /* 🛑 CONGELA GIOCATORE: Ferma ogni movimento */
          
          return;
          /* 🚪 ESCI DALLA FUNZIONE: Salta il codice rimanente */
        }
      
        switch (key) {
          /* 🔀 SWITCH TASTI: Azione diversa per ogni tasto */
          /* Modo efficiente per gestire più opzioni di tasto */
          
          case "ArrowLeft":
            /* ⬅️ FRECCIA SINISTRA: Muove il giocatore a sinistra */
            
            keys.leftKey.pressed = isPressed;
            /* 🔄 AGGIORNA STATO TASTO: Tiene traccia se il tasto è premuto */
            
            if (xVelocity === 0) {
              player.velocity.x = xVelocity;
              /* 🛑 VELOCITÀ ZERO: Per evento keyup */
              /* Quando si rilascia il tasto, ferma immediatamente il movimento */
            }
            player.velocity.x -= xVelocity;
            /* ⬅️ APPLICA VELOCITÀ: Muove a sinistra */
            /* Sottrae dalla velocità x per muoversi a sinistra */
            break;
            
          case "ArrowUp":
          case " ":
          case "Spacebar":
            /* ⬆️ SU/SPAZIO: Azione di salto */
            /* Più casi gestiscono diversi tasti di salto */
            /* Sia la freccia su che la barra spaziatrice attivano il salto */
            
            player.velocity.y -= 8;
            /* ⬆️ VELOCITÀ DI SALTO: Si muove verso l'alto */
            /* Velocità y negativa significa movimento verso l'alto */
            /* Valore 8 crea un'altezza di salto soddisfacente */
            break;
            
          case "ArrowRight":
            /* ➡️ FRECCIA DESTRA: Muove il giocatore a destra */
            ...
            player.velocity.x += xVelocity;
            /* ➡️ APPLICA VELOCITÀ: Muove a destra */
            /* Aggiunge alla velocità x per muoversi a destra */
        }
      }
      
      /* 🎮 ===== FUNZIONI GESTIONE GIOCO ===== */
      
      const startGame = () => {
        /* 🏁 AVVIO GIOCO: Inizializza il gameplay */
        
        canvas.style.display = "block";
        /* 🖼️ MOSTRA CANVAS: Rende il gioco visibile */
        /* Cambia il display da "none" a "block" */
        
        startScreen.style.display = "none";
        /* 🙈 NASCONDI SCHERMATA INIZIALE: Rimuove il menu */
        /* Una volta che il gioco inizia, non abbiamo più bisogno del menu */
        
        animate();
        /* 🎬 AVVIA ANIMAZIONE: Inizia il game loop */
        /* Questo lancia il motore di gioco principale */
      }
      
      const showCheckpointScreen = (msg) => {
        /* 🏆 NOTIFICA CHECKPOINT: Mostra messaggio di traguardo */
        /* msg = testo personalizzato per diversi checkpoint */
        
        checkpointScreen.style.display = "block";
        /* 📝 MOSTRA MESSAGGIO: Rende la notifica visibile */
        
        checkpointMessage.textContent = msg;
        /* 📝 IMPOSTA TESTO: Aggiorna il contenuto del messaggio */
        /* Usa il parametro per personalizzare il messaggio */
        
        if (isCheckpointCollisionDetectionActive) {
          /* ⏱️ VISUALIZZAZIONE TEMPORANEA: Solo se il gioco è ancora attivo */
          
          setTimeout(() => (checkpointScreen.style.display = "none"), 2000);
          /* ⏱️ RIMOZIONE TEMPORIZZATA: Nascondi dopo 2 secondi */
      ...
      /* 🖱️ ===== EVENT LISTENER: Gestione Input Utente ===== */
      
      startBtn.addEventListener("click", startGame);
      /* 🎬 LISTENER PULSANTE AVVIO: Inizia il gioco al click */
      /* Collega il pulsante HTML alla funzione JavaScript */
      
      window.addEventListener("keydown", ({ key }) => {
        /* 🎮 LISTENER PRESSIONE TASTI: Rileva quando i tasti vengono premuti */
        /* { key } usa la destrutturazione per estrarre la proprietà key dall'evento */
        /* Molto più pulito che scrivere (event) e poi event.key */
        
        movePlayer(key, 8, true);
        /* 🏃‍♂️ GESTISCI PRESSIONE TASTO: Muovi a velocità 8, tasto è premuto */
        /* true = tasto è premuto (evento keydown) */
      });
      
      window.addEventListener("keyup", ({ key }) => {
        /* 🎮 LISTENER RILASCIO TASTI: Rileva quando i tasti vengono rilasciati */
        /* Controparte a keydown - necessario per controlli fluidi */
        
        movePlayer(key, 0, false);
        /* 🛑 GESTISCI RILASCIO TASTO: Ferma movimento, tasto è rilasciato */
        /* 0 = velocità zero (ferma movimento) */
        /* false = tasto è rilasciato (evento keyup) */
      });
    </script>
  </body>
</html>

<!-- 🎯 ===== RIASSUNTO DEL GIOCO PLATFORMER ===== -->
<!-- 
🎮 ARCHITETTURA DEL GIOCO:
│
├── 🖥️ STRUTTURA HTML
│   ├── 📋 Schermata iniziale con istruzioni
│   ├── 🏆 Popup di notifica checkpoint
│   └── 🖼️ Superficie di gioco Canvas
│
├── 🎨 STILE CSS
│   ├── 🎮 Componenti dell'interfaccia di gioco
│   ├── 🔘 Stile pulsanti interattivi
│   └── 📱 Design responsive per tutti gli schermi
│
└── 🧠 MOTORE DI GIOCO JAVASCRIPT
    ├── 📦 Programmazione Orientata agli Oggetti (Classi)
    │   ├── 🧍 Player con fisica e collisioni
    │   ├── 🧱 Piattaforme per la navigazione
    │   └── 🚩 Checkpoint per gli obiettivi
    │
    ├── 🎮 Meccaniche di Gioco
    │   ├── ⬇️ Fisica di gravità e salto
    │   ├── 📷 Sistema di scorrimento camera
    │   ├── 💥 Rilevamento collisioni
    │   └── 🏆 Sistema di checkpoint progressivo
    │
    └── 🔄 Implementazione Tecnica
        ├── 🎬 Loop RequestAnimationFrame
        ├── 📏 Dimensionamento proporzionale per responsività
        ├── 🎮 Controlli da tastiera basati su eventi
        └── 🎯 Gestione dello stato per il progresso del gioco

Questo progetto dimostra i principi fondamentali dello sviluppo di giochi attraverso OOP!
Dalla simulazione fisica al rilevamento delle collisioni, è un motore di mini-gioco completo!
-->
```
</TabItem>
