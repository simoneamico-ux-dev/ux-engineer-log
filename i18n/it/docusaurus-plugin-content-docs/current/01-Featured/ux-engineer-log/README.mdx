...
Questo progetto rappresenta il punto di svolta del mio percorso. Se <strong><a href="https://github.com/simoneamico-ux-dev/from-factory-to-ux-engineer">from-factory-to-ux-engineer</a></strong> era il mio diario di bordo statico (GitHub usato come se fosse Google Drive), **UX Engineer Log** è il momento in cui il diario ha preso vita.
