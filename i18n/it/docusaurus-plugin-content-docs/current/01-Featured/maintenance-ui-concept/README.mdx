...
<img 
  ...
  loading="lazy"
  decoding="async" 
  style={{borderRadius: '10px', width: '100%', marginBottom: '30px', border: '1px solid var(--ifm-color-emphasis-200)'}} 
/>
...
<img 
  ...
  loading="lazy"
  decoding="async" 
  style={{borderRadius: '10px', width: '100%', border: '1px solid var(--ifm-color-emphasis-200)'}} 
/>
