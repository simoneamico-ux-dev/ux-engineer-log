...
<p className="article-meta"><time dateTime="2025-10-19">Scritto il 19 ottobre del 2025</time></p>
...
<figure className="image-caption-figure" style={{ textAlign: 'center', marginBottom: '20px' }}>
  ...
  />
  <figcaption className="image-caption image-caption--source"><em>Esempio pratico della calcolatrice statistica mentre analizza i dati di un sondaggio di soddisfazione utente (UX).</em></figcaption>
</figure>
