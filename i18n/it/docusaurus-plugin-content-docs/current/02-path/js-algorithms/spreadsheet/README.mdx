...
<p className="article-meta"><time dateTime="2025-10-22">Scritto il 22 ottobre del 2025</time></p>
...
<figure className="image-caption-figure" style={{ textAlign: 'center', marginBottom: '20px' }}>
  ...
  />
  <figcaption className="image-caption image-caption--source"><em>Esempio pratico dello Spreadsheet mentre analizza i dati di un test di usabilità.</em></figcaption>
</figure>
...
<figure className="image-caption-figure" style={{ textAlign: 'center', marginBottom: '20px' }}>
  ...
  />
  <figcaption className="image-caption image-caption--source"><em>Esempio pratico dello Spreadsheet utilizzato per analizzare rapidamente i risultati di un A/B Test.</em></figcaption>
</figure>
