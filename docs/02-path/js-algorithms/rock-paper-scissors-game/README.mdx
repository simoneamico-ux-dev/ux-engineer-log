...
<p className="article-meta"><time dateTime="2025-09-06">Written on September 6, 2025</time></p>

# Rock, Paper, Scissors Game

<img
  src={require('./assets/rock-paper-scissors-game-1.webp').default}
  alt="Rock, Paper, Scissors Game Project Preview (Main Page)"
  loading="lazy"
  decoding="async"
  width="1908"
  height="724"
...
<img
  ...
  alt="Rock, Paper, Scissors Game Project Preview - Computer Victory Screenshot"
  loading="lazy"
  decoding="async"
  width="1908"
  height="840"
