...
<p className="article-meta"><time dateTime="2025-11-15">Written on November 15, 2025</time></p>
...
<img
  ...
  alt="Cash Register Project Mobile UI Preview"
  loading="lazy"
  decoding="async"
  width="3432"
  height="1803"
...
The third project for the certification was the most significant one: **Mosaic**, an AI tool for therapists.
Given the depth of the visual design (Liquid Glass analysis, Accessibility) and the Open Source philosophy, I treated it as a standalone UI Design Concept.

<strong><Link to="/docs/featured/mosaic-ui-concept">Explore the Mosaic Concept</Link></strong>
<br />
<br />
</div>
