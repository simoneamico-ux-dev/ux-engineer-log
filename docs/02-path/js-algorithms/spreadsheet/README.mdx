...
<p className="article-meta"><time dateTime="2025-10-22">Written on October 22, 2025</time></p>
...
<figure className="image-caption-figure" style={{ textAlign: 'center', marginBottom: '20px' }}>
  ...
  />
  <figcaption className="image-caption image-caption--source"><em>Practical example of the Spreadsheet analyzing usability test data.</em></figcaption>
</figure>
...
<figure className="image-caption-figure" style={{ textAlign: 'center', marginBottom: '20px' }}>
  ...
  />
  <figcaption className="image-caption image-caption--source"><em>Practical example of the Spreadsheet used to quickly analyze A/B Test results.</em></figcaption>
</figure>
