...
<p className="article-meta"><time dateTime="2025-10-19">Written on October 19, 2025</time></p>
...
<figure className="image-caption-figure" style={{ textAlign: 'center', marginBottom: '20px' }}>
  ...
  />
  <figcaption className="image-caption image-caption--source"><em>Practical example of the Statistics Calculator analyzing user satisfaction survey (UX) data.</em></figcaption>
</figure>
