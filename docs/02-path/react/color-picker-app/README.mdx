...
<p className="article-meta"><time dateTime="2026-02-17">Written on February 17, 2026</time></p>

# Color Picker App

<ThemedImage
  alt="Screenshot of the application showing the minimalist interface with the native color picker centered on a background with the selected Hex code"
  sources={{
