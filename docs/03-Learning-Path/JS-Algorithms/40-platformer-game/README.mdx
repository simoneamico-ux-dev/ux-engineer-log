...
```html
<!DOCTYPE html>
<!-- 🎮 HTML5 DECLARATION: "Welcome to our 2D Platformer Game!" -->
<!-- It's like placing the foundation for our digital playground! 🏗️ -->

<html lang="en">
<!-- 🌍 MAIN CONTAINER: The entire game universe -->
<!-- lang="en" = English language, universal for coding experiences -->

  <head>
    <!-- 🧠 THE COMMAND CENTER: Where we set up the game environment -->
    <!-- Like the control room of an arcade machine! 🕹️ -->
    
    <meta charset="UTF-8" />
    <!-- 📝 CHARACTER ENCODING: Supports all text symbols needed for our game -->
    <!-- UTF-8 ensures everything from game text to code comments displays correctly -->
    
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <!-- 🔄 BROWSER COMPATIBILITY: Ensures modern IE rendering -->
    <!-- Tells Internet Explorer to use its most modern rendering engine -->
    
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <!-- 📱 RESPONSIVE SETUP: "This game adapts to any screen!" -->
    <!-- Makes our game properly sized on all devices from phones to desktops -->
    
    <title>Learn Intermediate OOP by Building a Platformer Game</title>
    <!-- 📑 TAB TITLE: Educational purpose clearly defined -->
    <!-- OOP = Object-Oriented Programming, the foundation of modern game development -->
    
    <style>
      /* 🎨 ===== CSS STYLES: The Visual Game World ===== */
      
      * {
        margin: 0;
        padding: 0;
        box-sizing: border-box;
        /* 🧹 CLEAN SLATE: Reset all browser default spacing */
      ...
      :root {
        ...
        --section-bg-color: #ffffff;
        --golden-yellow: #feac32;
        /* 🎨 COLOR VARIABLES: Central palette definition */
      ...
      body {
        background-color: var(--main-bg-color);
        /* 🌌 DEEP BLUE BACKGROUND: Creates an immersive atmosphere */
      ...
      .start-screen {
        ...
        margin-right: -50%;
        transform: translate(-50%, -50%);
        /* ⚖️ PERFECT CENTERING: The transform trick centers the element precisely */
        /* Horizontally AND vertically centered regardless of content size */
        
        border-radius: 30px;
        /* 🔄 ROUNDED CORNERS: Soften the visual appearance */
        /* Creates a more modern, friendly UI for players */
        
        padding: 20px;
        padding-bottom: 5px;
        /* 📏 INTERNAL SPACING: Breathing room for content */
        /* Different top/bottom padding creates visual balance */
      }
      
      .main-title {
        text-align: center;
        /* ⚖️ CENTERED TITLE: Focal point of the start screen */
      ...
      .instructions {
        ...
        margin: 15px;
        line-height: 2rem;
        /* 📝 CLEAR INSTRUCTIONS: Readability optimized text */
      ...
      .btn {
        cursor: pointer;
        /* 👆 HAND CURSOR: Visual cue that element is clickable */
        
        width: 100px;
        margin: 10px;
        /* 📏 BUTTON DIMENSIONS: Comfortable click target size */
        /* 100px wide with 10px margin creates good spacing */
        
        color: #0a0a23;
        font-size: 18px;
        /* 🔤 TEXT STYLE: Dark text on light button for readability */
        /* 18px font ensures text is easily readable on all devices */
        
        background-color: var(--golden-yellow);
        background-image: linear-gradient(#fecc4c, #ffac33);
        /* 🌅 GRADIENT BACKGROUND: Creates 3D button effect */
        /* Top lighter, bottom darker creates illusion of light from above */
        
        border-color: var(--golden-yellow);
        border-width: 3px;
        /* 🔲 BORDER STYLE: Thick border matches background */
        /* 3px width makes the border clearly visible */
      }
      
      .btn:hover {
        background-image: linear-gradient(#ffcc4c, #f89808);
        /* ✨ HOVER EFFECT: Button brightens when mouse hovers */
      ...
      .btn-container {
        ...
        align-items: center;
        justify-content: center;
        /* 📦 FLEXBOX CENTERING: Perfect horizontal alignment */
      ...
      .checkpoint-screen {
        ...
        margin-left: auto;
        margin-right: auto;
        /* ⚖️ HORIZONTAL CENTERING: Old-school technique */
        ...
        border-radius: 20px;
        padding: 10px;
        /* 📋 POPUP STYLING: Clean, readable notification */
        /* White background with rounded corners for a modern look */
        
        display: none;
        /* 🙈 INITIALLY HIDDEN: Only appears at checkpoints */
        /* JavaScript will change this to "block" when needed */
      }
      
      #canvas {
        display: none;
        /* 🙈 HIDDEN CANVAS: Revealed when game starts */
        /* Initially hidden to show start screen instead */
      }
      
      @media (min-width: 768px) {
        /* 📱 RESPONSIVE BREAKPOINT: Tablet and larger screens */
        /* 768px is standard tablet portrait width */
        
        .start-screen {
          width: 60%;
          max-width: 700px;
          /* 📏 DESKTOP SIZING: Narrower, centered panel */
        ...
        .checkpoint-screen {
          max-width: 300px;
          /* 📏 NOTIFICATION SIZING: Compact on larger screens */
  ...
  <body>
    <!-- 🎮 ===== THE GAME INTERFACE: Player's View into the Game World ===== -->
    
    <div class="start-screen">
      <!-- 🎬 START SCREEN: The initial game menu -->
      <!-- Like the title screen of classic arcade games! -->
      
      <h1 class="main-title">freeCodeCamp Code Warrior</h1>
      <!-- 📑 GAME TITLE: Establishes theme and branding -->
      <!-- "Code Warrior" suggests a coding-themed adventure -->
      
      <p class="instructions">
        Help the main player navigate to the yellow checkpoints.
      </p>
      <!-- 📝 GAME OBJECTIVE: Clear description of goals -->
      <!-- Tells player exactly what they need to accomplish -->
      
      <p class="instructions">
        Use the keyboard arrows to move the player around.
      </p>
      <!-- 🎮 CONTROL SCHEME 1: Movement controls explained -->
      <!-- Arrow keys are intuitive for 2D movement -->
      
      <p class="instructions">You can also use the spacebar to jump.</p>
      <!-- 🎮 CONTROL SCHEME 2: Jump mechanic explained -->
      <!-- Spacebar is the standard jump button in most platformers -->

      <div class="btn-container">
        <!-- 📦 BUTTON WRAPPER: Centers the start button -->
    ...
    <div class="checkpoint-screen">
      <!-- 🏆 CHECKPOINT NOTIFICATION: Appears when reaching goals -->
      ...
      <p>You reached the last checkpoint.</p>
      <!-- 📝 ACHIEVEMENT MESSAGE: Clarifies what happened -->
      <!-- Will be updated via JavaScript for different checkpoints -->
    </div>

    <canvas id="canvas"></canvas>
    <!-- 🖼️ CANVAS ELEMENT: The actual game rendering surface -->
    ...
    <script>
      ...
      /* 🔍 ===== DOM ELEMENT SELECTION: Connecting JS to HTML ===== */
      
      const startBtn = document.getElementById("start-btn");
      /* 🔘 START BUTTON REFERENCE: Direct access by ID */
      ...
      canvas.width = innerWidth;
      canvas.height = innerHeight;
      /* 📏 CANVAS DIMENSIONS: Full screen size */
      ...
      /* 🌍 ===== GAME PHYSICS CONSTANTS: The Rules of Our World ===== */
      
      const gravity = 0.5;
      /* ⬇️ GRAVITY CONSTANT: Force pulling player down */
      /* This isn't realistic Earth gravity (9.8 m/s²) but a value that feels good */
      /* Each frame adds 0.5 to vertical velocity → accelerating fall */
      /* Higher values = faster falling, lower values = floatier jumps */
      
      let isCheckpointCollisionDetectionActive = true;
      /* 🚦 COLLISION FLAG: Controls checkpoint detection */
      ...
      /* 📏 ===== SCALING FUNCTION: Responsive Game Elements ===== */
      
      const proportionalSize = (size) => {
        return innerHeight < 500 ? Math.ceil((size / 500) * innerHeight) : size;
        /* 📱 ADAPTIVE SCALING: Elements resize for small screens */
        /* If screen height < 500px: scales everything proportionally */
        /* Formula: (size ÷ reference height) × actual height */
      ...
      class Player {
        ...
        constructor() {
          ...
          /* 📍 STARTING POSITION: Where player begins */
        ...
        draw() {
          ...
          ctx.fillRect(this.position.x, this.position.y, this.width, this.height);
          /* 📦 DRAW RECTANGLE: Creates the player shape */
      ...
      /* 🧱 ===== PLATFORM CLASS: The Solid Ground ===== */
      
      class Platform {
        /* 📘 CLASS DEFINITION: Blueprint for platforms */
        /* Each platform is a surface the player can stand on */
        
        constructor(x, y) {
          /* 🏗️ CONSTRUCTOR WITH PARAMETERS: Customizable platforms */
      ...
      const platformPositions = [
        ...
        { x: 900, y: proportionalSize(350) },
        { x: 1050, y: proportionalSize(150) },
        { x: 2500, y: proportionalSize(450) },  /* Big gap → challenge! */
        { x: 2900, y: proportionalSize(400) },
        { x: 3150, y: proportionalSize(350) },
      ...
      /* 🗺️ LEVEL DESIGN: Platform coordinates array */
      ...
      /* 🏭 PLATFORM CREATION: Transforms data into objects */
      /* map() converts each position into a functional Platform */
      /* This is like a factory assembly line: data in → objects out */
      ...
      /* 🚩 CHECKPOINT LOCATIONS: Objective coordinates */
      ...
      /* 🏭 CHECKPOINT CREATION: Transforms data into objects */
      /* Same mapping pattern as platforms, creating CheckPoint objects */
      
      /* 🔄 ===== GAME LOOP: The Animation Engine ===== */
      
      const animate = () => {
        /* 🎬 MAIN GAME LOOP: Function runs every frame */
        /* This is the heartbeat of our game - everything happens here */
        
        requestAnimationFrame(animate);
        /* 🔄 LOOP CREATION: Browser animation API */
        ...
        ctx.clearRect(0, 0, canvas.width, canvas.height);
        /* 🧹 CLEAR CANVAS: Wipes previous frame */
        ...
        /* 🎨 DRAW PLATFORMS: Render all platforms */
        ...
        /* 🎨 DRAW CHECKPOINTS: Render all checkpoints */
        /* Same pattern as platforms - draw each checkpoint */
      
        player.update();
        /* 🔄 UPDATE PLAYER: Physics and rendering */
        /* This calls the player's update method which:
           1. Draws the player
           2. Updates position based on velocity
           3. Applies gravity and boundary checks */
      
        /* 📷 ===== CAMERA MOVEMENT: Scrolling The World ===== */
        
        if (keys.rightKey.pressed && player.position.x < proportionalSize(400)) {
          /* 🏃‍♂️ PLAYER MOVEMENT RIGHT: Move player when away from center */
          /* When right key pressed AND player left of center point */
          
          player.velocity.x = 5;
          /* ➡️ SET VELOCITY: Move player right */
          /* 5 pixels per frame creates smooth movement */
        } else if (keys.leftKey.pressed && player.position.x > proportionalSize(100)) {
          /* 🏃‍♂️ PLAYER MOVEMENT LEFT: Move player when away from left edge */
          /* When left key pressed AND player right of left boundary */
          
          player.velocity.x = -5;
          /* ⬅️ SET VELOCITY: Move player left */
          /* Negative velocity means leftward movement */
        } else {
          /* 🛑 CENTRAL POSITION: Player near center or edges */
          
          player.velocity.x = 0;
          /* 🛑 STOP HORIZONTAL MOVEMENT: Player stationary */
          /* Reset velocity to zero - player stops moving horizontally */
      
          /* 🌎 WORLD SCROLLING: Move environment instead of player */
          /* This creates the illusion of a moving camera following the player */
          
          if (keys.rightKey.pressed && isCheckpointCollisionDetectionActive) {
            /* ➡️ SCROLL RIGHT: Move world when player centered */
            /* Active only when checkpoint collision is enabled */
            
            platforms.forEach((platform) => {
              platform.position.x -= 5;
              /* ⬅️ MOVE PLATFORMS LEFT: World scrolls opposite to player direction */
              /* Creates illusion of player moving right */
            });
      
            checkpoints.forEach((checkpoint) => {
              checkpoint.position.x -= 5;
              /* ⬅️ MOVE CHECKPOINTS LEFT: Keep synchronized with platforms */
              /* Everything in world moves together for consistent scrolling */
            });
          
          } else if (keys.leftKey.pressed && isCheckpointCollisionDetectionActive) {
            /* ⬅️ SCROLL LEFT: Move world when player centered */
            
            platforms.forEach((platform) => {
              platform.position.x += 5;
              /* ➡️ MOVE PLATFORMS RIGHT: World scrolls opposite to player direction */
              /* Creates illusion of player moving left */
            });
      
            checkpoints.forEach((checkpoint) => {
              checkpoint.position.x += 5;
              /* ➡️ MOVE CHECKPOINTS RIGHT: Keep synchronized with platforms */
            });
          }
        }
        ...
        platforms.forEach((platform) => {
          /* 🔍 CHECK EACH PLATFORM: Iterate through all platforms */
          
          const collisionDetectionRules = [
            player.position.y + player.height <= platform.position.y,
            /* ⬇️ RULE 1: Player's bottom above platform's top */
            /* Ensures player is descending onto platform from above */
            
            player.position.y + player.height + player.velocity.y >= platform.position.y,
            /* ⬇️ RULE 2: Player's next position will intersect platform */
            /* Predicts collision based on current velocity */
            
            player.position.x >= platform.position.x - player.width / 2,
            /* ⬅️ RULE 3: Player not too far left of platform */
            /* Horizontal position check - left edge */
            
            player.position.x <=
              platform.position.x + platform.width - player.width / 3,
            /* ➡️ RULE 4: Player not too far right of platform */
            /* Horizontal position check - right edge */
          ];
      
          if (collisionDetectionRules.every((rule) => rule)) {
            /* ✅ ALL RULES TRUE: Standing on platform */
            /* every() checks if ALL conditions return true */
            /* This is like a logical AND between all conditions */
            
            player.velocity.y = 0;
            /* 🛑 STOP FALLING: Land on platform */
            /* Zero vertical velocity prevents falling through platform */
            
            return;
            /* 🚪 EXIT LOOP: Skip remaining platforms */
          ...
          const platformDetectionRules = [
            player.position.x >= platform.position.x - player.width / 2,
            /* ⬅️ RULE 1: Horizontal overlap check (left) */
            
            player.position.x <=
              platform.position.x + platform.width - player.width / 3,
            /* ➡️ RULE 2: Horizontal overlap check (right) */
            
            player.position.y + player.height >= platform.position.y,
            /* ⬆️ RULE 3: Player's bottom below platform's top */
            
            player.position.y <= platform.position.y + platform.height,
            /* ⬇️ RULE 4: Player's top above platform's bottom */
          ];
      
          if (platformDetectionRules.every(rule => rule)) {
            /* ✅ ALL RULES TRUE: Hitting platform from below */
            
            player.position.y = platform.position.y + player.height;
            /* ⬇️ PUSH DOWN: Move player below platform */
            /* Prevents getting stuck inside platform */
            
            player.velocity.y = gravity;
            /* ⬇️ START FALLING: Apply gravity */
        ...
        checkpoints.forEach((checkpoint, index, checkpoints) => {
          /* 🔍 CHECK EACH CHECKPOINT: Iterate through all checkpoints */
          /* index = position in array, checkpoints = the full array */
          
          const checkpointDetectionRules = [
            player.position.x >= checkpoint.position.x,
            /* ➡️ RULE 1: Player right edge beyond checkpoint left */
            
            player.position.y >= checkpoint.position.y,
            /* ⬇️ RULE 2: Player below top of checkpoint */
            
            player.position.y + player.height <=
              checkpoint.position.y + checkpoint.height,
            /* ⬆️ RULE 3: Player within vertical bounds of checkpoint */
            
            isCheckpointCollisionDetectionActive,
            /* 🚦 RULE 4: Collision detection system is active */
            /* Prevents multiple activations when global switch is off */
            
            player.position.x - player.width <=
              checkpoint.position.x - checkpoint.width + player.width * 0.9,
            /* ⬅️ RULE 5: Complex horizontal alignment check */
            /* Ensures player is properly positioned relative to checkpoint */
            
            index === 0 || checkpoints[index - 1].claimed === true,
            /* 🔢 RULE 6: Checkpoint order check */
            /* Either this is the first checkpoint OR previous one was claimed */
            /* Forces sequential checkpoint collection */
          ];
      
          if (checkpointDetectionRules.every((rule) => rule)) {
            /* ✅ ALL RULES TRUE: Checkpoint reached */
            
            checkpoint.claim();
            /* 🏁 CLAIM CHECKPOINT: Mark as reached */
            /* This hides the checkpoint and marks it claimed */
      
            if (index === checkpoints.length - 1) {
              /* 🏆 FINAL CHECKPOINT: Last in array */
              /* Length - 1 is the index of the last item */
              
              isCheckpointCollisionDetectionActive = false;
              /* 🚫 DISABLE COLLISIONS: Game effectively ends */
              /* Prevents further checkpoint activations */
              
              showCheckpointScreen("You reached the final checkpoint!");
              /* 🎉 VICTORY MESSAGE: Final achievement */
              /* Shows celebration message with custom text */
              
              movePlayer("ArrowRight", 0, false);
              /* 🛑 STOP PLAYER: Prevent movement after winning */
              /* Reset movement state to make player stand still */
            } else if (player.position.x >= checkpoint.position.x && player.position.x <= checkpoint.position.x + 40) {
              /* ✅ REGULAR CHECKPOINT: Not the final one */
              /* Additional position check ensures proper trigger timing */
              
              showCheckpointScreen("You reached a checkpoint!");
              /* 🎉 PROGRESS MESSAGE: Intermediate achievement */
            }
          };
        });
      }
      ...
      /* 🎮 KEYBOARD STATE OBJECT: Tracks pressed keys */
      /* Nested objects: keys → rightKey → pressed */
      /* Using boolean flags instead of checking key state every frame */
      /* This allows for smooth, consistent movement */
      
      const movePlayer = (key, xVelocity, isPressed) => {
        /* 🏃‍♂️ PLAYER MOVEMENT FUNCTION: Processes key actions */
        /* key = which key was pressed */
        /* xVelocity = how fast to move */
        /* isPressed = key down or key up? */
        
        if (!isCheckpointCollisionDetectionActive) {
          /* 🚫 GAME OVER CHECK: Block movement if game ended */
          ...
          return;
          /* 🚪 EXIT FUNCTION: Skip remaining code */
        }
      
        switch (key) {
          /* 🔀 KEY SWITCH: Different action for each key */
          ...
          case "ArrowLeft":
            ...
            keys.leftKey.pressed = isPressed;
            /* 🔄 UPDATE KEY STATE: Track if key is down */
            
            if (xVelocity === 0) {
              player.velocity.x = xVelocity;
              /* 🛑 ZERO VELOCITY: For key up event */
              /* When releasing key, stop moving immediately */
            }
            player.velocity.x -= xVelocity;
            /* ⬅️ APPLY VELOCITY: Move left */
      ...
      const startGame = () => {
        /* 🏁 GAME STARTER: Initializes gameplay */
        
        canvas.style.display = "block";
        /* 🖼️ SHOW CANVAS: Make game visible */
        /* Changes display from "none" to "block" */
        
        startScreen.style.display = "none";
        /* 🙈 HIDE START SCREEN: Remove menu */
        /* Once game starts, we don't need the menu */
        
        animate();
        /* 🎬 START ANIMATION: Begin game loop */
        /* This launches the core game engine */
      }
      
      const showCheckpointScreen = (msg) => {
        /* 🏆 CHECKPOINT NOTIFIER: Displays achievement message */
        /* msg = custom text for different checkpoints */
        
        checkpointScreen.style.display = "block";
        /* 📝 SHOW MESSAGE: Make notification visible */
        
        checkpointMessage.textContent = msg;
        /* 📝 SET TEXT: Update message content */
        /* Uses the parameter to customize the message */
        
        if (isCheckpointCollisionDetectionActive) {
          /* ⏱️ TEMPORARY DISPLAY: Only if game still active */
          
          setTimeout(() => (checkpointScreen.style.display = "none"), 2000);
          /* ⏱️ TIMED REMOVAL: Hide after 2 seconds */
          /* setTimeout runs the function after delay in milliseconds */
          /* Arrow function with parentheses around single statement */
        }
      };
      
      /* 🖱️ ===== EVENT LISTENERS: User Input Handling ===== */
      
      startBtn.addEventListener("click", startGame);
      /* 🎬 START BUTTON LISTENER: Begin game on click */
      /* Connects HTML button to JavaScript function */
      
      window.addEventListener("keydown", ({ key }) => {
        /* 🎮 KEY PRESS LISTENER: Detect when keys are pressed */
        /* { key } uses destructuring to extract key property from event */
        /* Much cleaner than writing (event) and then event.key */
        
        movePlayer(key, 8, true);
        /* 🏃‍♂️ HANDLE KEY PRESS: Move at speed 8, key is pressed */
        /* true = key is pressed (keydown event) */
      });
      
      window.addEventListener("keyup", ({ key }) => {
        /* 🎮 KEY RELEASE LISTENER: Detect when keys are released */
        /* Counterpart to keydown - needed for smooth controls */
        
        movePlayer(key, 0, false);
        /* 🛑 HANDLE KEY RELEASE: Stop movement, key is released */
...
└── 🧠 JAVASCRIPT GAME ENGINE
    ...
    │   └── 🚩 Checkpoints for objectives
    │
    ├── 🎮 Game Mechanics
    │   ├── ⬇️ Gravity and jumping physics
    ...
    └── 🔄 Technical Implementation
        ...
        ├── 📏 Proportional sizing for responsiveness
