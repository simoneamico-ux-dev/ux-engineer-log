...
<p className="article-meta"><time dateTime="2026-01-14">Written on January 14, 2026</time></p>
...
<div style={{ display: 'flex', justifyContent: 'center', margin: '20px 0' }}>
  <figure className="image-caption-figure" style={{ maxWidth: '320px' }}>
    ...
    />
    <figcaption className="image-caption image-caption--version">Version 1.0 (2024)</figcaption>
  </figure>
</div>
...
I think it’s the same theme as public speaking. Carlo Loiudice used to say (I don’t remember whether in one of his courses or in his podcasts) that the audience is selfish: they don’t care who you are, what you’ve done, or why you’re there talking, they care about **what they take home** from what you say. <br />
