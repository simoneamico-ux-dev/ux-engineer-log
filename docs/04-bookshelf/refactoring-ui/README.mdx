...
<p className="article-meta"><time dateTime="2026-03-11">Written on March 11, 2026</time></p>
...
<div style={{ 
  ...
  <p className="hero-subtitle">Copy-paste components,<br />zero dependencies</p>
</div>
