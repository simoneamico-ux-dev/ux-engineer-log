...
<p className="article-meta"><time dateTime="2025-12-22">Written on December 22, 2025</time></p>
...
<div style={{
  ...
  <figure className="image-caption-figure" style={{ flex: '0.647 1 0px', minWidth: '200px' }}>
    ...
    />
    <figcaption className="image-caption image-caption--media">Figma Prototype</figcaption>
  </figure>
  ...
  <figure className="image-caption-figure" style={{ flex: '1.593 1 0px', minWidth: '280px' }}>
    ...
    />
    <figcaption className="image-caption image-caption--media">Live Implementation (Code) • 0.5x Speed</figcaption>
  </figure>
